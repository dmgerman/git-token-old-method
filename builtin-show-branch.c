...
index|[]
init|=
literal|"git-show-branch [--sparse] [--current] [--all] [--heads] [--tags] [--topo-order] [--more=count | --list | --independent | --merge-base ] [--topics] [<refs>...] | --reflog[=n]<branch>"
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
name|die
argument_list|(
literal|"unrecognized reflog count '%s'"
argument_list|,
name|arg
operator|+
literal|9
...
operator|++
expr_stmt|;
comment|/* Only one of these is allowed */
if|if
condition|(
literal|1
operator|<
