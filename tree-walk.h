...
literal|0
block|,
comment|/* This includes out-of-tree links */
...
literal|1
block|,
comment|/* The initial symlink is missing */
...
literal|2
block|,
comment|/* 				* The initial symlink is there, but 				* (transitively) points to a missing 				* in-tree file 				*/
...
literal|4
block|,
comment|/* 		       * Somewhere along the symlink chain, a path is 		       * requested which contains a file as a 		       * non-final element. 		       */
block|}
enum|;
end_enum
begin_function_decl
