...
literal|0
decl_stmt|;
comment|/* 	 * The line is a newly added line.  Does it have funny leading 	 * whitespaces?  In indent, SP should never precede a TAB.  In 	 * addition, under "indent with non tab" rule, there should not 	 * be more than 8 consecutive spaces. 	 */
for|for
control|(
name|i
operator|=
...
name|die
argument_list|(
literal|"--check may not be used with --quiet or --exit-code"
argument_list|)
expr_stmt|;
block|}
if|if
