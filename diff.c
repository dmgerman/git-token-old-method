...
name|cmd
decl_stmt|;
comment|/* diff_cmd and diff_arg have 8 %s in total which makes 	 * the sum of these strings 16 bytes larger than required. 	 * we use 2 spaces around diff-opts, and we need to count 	 * terminating NUL, so we subtract 13 here. 	 */
name|int
name|cmd_size
init|=
operator|(
