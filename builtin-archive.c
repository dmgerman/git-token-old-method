...
argument_list|)
expr_stmt|;
comment|/* 		 * This is safe because either --format and/or --output must 		 * have been given on the original command line if we get to 		 * this point, and parse_options() must have eaten at least 		 * one argument, i.e. we have enough room to append to argv[]. 		 */
name|argv
index|[
name|argc
operator|++
