...
end_function
begin_comment
comment|/*  * If the glob starts with a subdirectory, append it to  * the prefix instead, for more efficient operation.  *  * But we do not update the "prefix_offset", which tells  * how much of the name to ignore at printout.  */
end_comment
begin_function
