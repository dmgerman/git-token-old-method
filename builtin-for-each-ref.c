...
parameter_list|)
block|{
comment|/* Sheesh, we really should make for-each-ref to take 	 * callback data. 	 */
operator|*
name|cnt
operator|=
literal|0
...
name|die
argument_list|(
literal|"The number %s did not parse"
argument_list|,
name|arg
argument_list|)
expr_stmt|;
