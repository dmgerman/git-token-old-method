...
literal|0
return|;
comment|/* If we are showing hunk marks, we should not do it for the 	 * first match. The synchronization problem we get for this 	 * constraint is not yet solved, so we disable threading in 	 * this case. 	 */
if|if
condition|(
name|opt
operator|->
