...
end_function
begin_comment
comment|/*  * If the git_dir is not directly inside the working tree, then git will not  * find it by default, and we need to set the worktree explicitly.  */
end_comment
begin_function
DECL|function|needs_work_tree_config
specifier|static
name|int
name|needs_work_tree_config
parameter_list|(
specifier|const
name|char
modifier|*
