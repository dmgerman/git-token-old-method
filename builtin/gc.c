...
specifier|static
name|void
name|process_log_file_on_signal
parameter_list|(
name|int
name|signo
parameter_list|)
...
name|_
argument_list|(
literal|"Invalid gc.pruneexpire: '%s'"
argument_list|)
argument_list|,
name|prune_expire
argument_list|)
...
name|_
argument_list|(
literal|"The last gc run reported the following. "
literal|"Please correct the root cause\n"
literal|"and remove %s.\n"
literal|"Automatic cleanup will not be performed "
literal|"until the file is removed.\n\n"
literal|"%s"
argument_list|)
argument_list|,
name|git_path
