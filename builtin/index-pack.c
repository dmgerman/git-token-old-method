...
end_define
begin_struct
DECL|struct|ofs_delta_entry
struct|struct
name|ofs_delta_entry
block|{
DECL|member|offset
name|off_t
name|offset
...
end_struct
begin_struct
DECL|struct|ref_delta_entry
struct|struct
name|ref_delta_entry
block|{
DECL|member|sha1
name|unsigned
name|char
...
end_decl_stmt
begin_decl_stmt
DECL|variable|ref_deltas_alloc
specifier|static
name|int
name|ref_deltas_alloc
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
name|type_cas_lock
parameter_list|()
value|lock_mutex(&type_cas_mutex)
end_define
begin_define
...
parameter_list|()
value|unlock_mutex(&type_cas_mutex)
end_define
begin_decl_stmt
DECL|variable|key
specifier|static
...
end_function
begin_function
DECL|function|compare_ofs_delta_bases
specifier|static
name|int
name|compare_ofs_delta_bases
parameter_list|(
name|off_t
name|offset1
parameter_list|,
...
end_function
begin_function
DECL|function|find_ofs_delta_children
specifier|static
name|void
name|find_ofs_delta_children
parameter_list|(
name|off_t
name|offset
parameter_list|,
...
end_function
begin_function
DECL|function|compare_ref_delta_bases
specifier|static
name|int
name|compare_ref_delta_bases
parameter_list|(
specifier|const
name|unsigned
name|char
...
end_function
begin_function
DECL|function|find_ref_delta_children
specifier|static
name|void
name|find_ref_delta_children
parameter_list|(
specifier|const
name|unsigned
name|char
...
end_function
begin_comment
comment|/*  * Standard boolean compare-and-swap: atomically check whether "*type" is  * "want"; if so, swap in "set" and return true. Otherwise, leave it untouched  * and return false.  */
end_comment
begin_function
DECL|function|compare_and_swap_type
specifier|static
name|int
name|compare_and_swap_type
parameter_list|(
name|signed
name|char
modifier|*
...
name|die
argument_list|(
literal|"BUG: child->real_type != OBJ_REF_DELTA"
argument_list|)
expr_stmt|;
name|resolve_delta
argument_list|(
...
end_function
begin_function
DECL|function|compare_ofs_delta_entry
specifier|static
name|int
name|compare_ofs_delta_entry
parameter_list|(
specifier|const
name|void
modifier|*
