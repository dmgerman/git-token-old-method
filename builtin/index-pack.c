...
name|ofs_last
decl_stmt|;
comment|/* 	 * This is a recursive function. Those brackets should help reducing 	 * stack usage by limiting the scope of the delta_base union. 	 */
block|{
name|union
name|delta_base
name|base_spec
...
index|]
decl_stmt|;
comment|/* NEEDSWORK: Compute data necessary for the "histogram" here */
if|if
condition|(
name|stat_only
condition|)
