...
specifier|static
name|int
name|git_config_get_notes_strategy
parameter_list|(
specifier|const
name|char
modifier|*
...
if|if
condition|(
name|parse_notes_merge_strategy
argument_list|(
name|value
argument_list|,
name|strategy
...
name|die
argument_list|(
literal|"BUG: local ref %s is outside of refs/notes/"
argument_list|,
name|o
operator|.
name|local_ref
