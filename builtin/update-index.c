...
name|_
argument_list|(
literal|"failed to create file %s"
argument_list|)
argument_list|,
name|path
argument_list|)
...
name|_
argument_list|(
literal|"failed to delete file %s"
argument_list|)
argument_list|,
name|path
argument_list|)
...
name|_
argument_list|(
literal|"failed to delete directory %s"
argument_list|)
argument_list|,
name|path
argument_list|)
...
parameter_list|)
block|{
comment|/* 	 * not use if we could usleep(10) if USE_NSEC is defined. The 	 * field nsec could be there, but the OS could choose to 	 * ignore it? 	 */
name|sleep
argument_list|(
literal|1
argument_list|)
...
specifier|static
name|int
name|test_if_untracked_cache_is_supported
parameter_list|(
name|void
parameter_list|)
block|{
...
name|_
argument_list|(
literal|"directory stat info does not "
literal|"change after adding a new file"
argument_list|)
argument_list|)
expr_stmt|;
goto|goto
...
name|_
argument_list|(
literal|"directory stat info does not change "
literal|"after adding a new directory"
argument_list|)
argument_list|)
expr_stmt|;
goto|goto
...
name|_
argument_list|(
literal|"directory stat info changes "
literal|"after updating a file"
argument_list|)
argument_list|)
expr_stmt|;
goto|goto
...
name|_
argument_list|(
literal|"directory stat info changes after "
literal|"adding a file inside subdirectory"
argument_list|)
argument_list|)
expr_stmt|;
goto|goto
...
argument_list|(
literal|"directory stat info does not "
literal|"change after deleting a file"
argument_list|)
argument_list|)
expr_stmt|;
goto|goto
...
argument_list|(
literal|"directory stat info does not "
literal|"change after deleting a directory"
argument_list|)
argument_list|)
expr_stmt|;
goto|goto
...
specifier|static
name|int
name|parse_new_style_cacheinfo
parameter_list|(
specifier|const
name|char
modifier|*
...
literal|1
return|;
comment|/* not a new-style cacheinfo */
operator|*
name|mode
operator|=
name|ul
...
name|error
argument_list|(
literal|"option 'cacheinfo' expects<mode>,<sha1>,<path>"
argument_list|)
return|;
if|if
condition|(
...
name|N_
argument_list|(
literal|"enable or disable split index"
argument_list|)
argument_list|)
block|,
name|OPT_BOOL
...
name|N_
argument_list|(
literal|"enable/disable untracked cache"
argument_list|)
argument_list|)
block|,
name|OPT_SET_INT
...
name|N_
argument_list|(
literal|"test if the filesystem supports untracked cache"
argument_list|)
argument_list|,
name|UC_TEST
argument_list|)
...
condition|)
block|{
comment|/* 		 * can't discard_split_index(&the_index); because that 		 * will destroy split_index->base->cache[], which may 		 * be shared with the_index.cache[]. So yeah we're 		 * leaking a bit here. 		 */
name|the_index
operator|.
name|split_index
operator|=
