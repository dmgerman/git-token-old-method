...
end_decl_stmt
begin_comment
comment|/*  * Parse a sort string, and return 0 if parsed successfully. Will return  * non-zero when the sort string does not parse into a known type. If var is  * given, the error message becomes a warning and includes information about  * the configuration value.  */
end_comment
begin_function
DECL|function|parse_sort_string
specifier|static
name|int
name|parse_sort_string
parameter_list|(
specifier|const
name|char
modifier|*
...
name|_
argument_list|(
literal|"unsupported sort specification '%s'"
argument_list|)
argument_list|,
name|arg
argument_list|)
...
name|_
argument_list|(
literal|"unsupported sort specification '%s' in variable '%s'"
argument_list|)
argument_list|,
name|var
argument_list|,
...
name|_
argument_list|(
literal|"--sort and -n are incompatible"
argument_list|)
argument_list|)
expr_stmt|;
name|ret
