...
block|,
DECL|enumerator|REBASE_INTERACTIVE
...
end_decl_stmt
begin_decl_stmt
DECL|variable|config_autostash
specifier|static
name|int
name|config_autostash
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
name|opt_rebase
block|,
literal|"false|true|preserve|interactive"
block|,
name|N_
argument_list|(
...
name|N_
argument_list|(
literal|"automatically stash/stash pop before and after rebase"
argument_list|)
argument_list|)
block|,
...
name|N_
argument_list|(
literal|"number of submodules pulled in parallel"
argument_list|)
argument_list|,
name|PARSE_OPT_OPTARG
argument_list|)
...
end_function
begin_comment
comment|/**  * Read config variables.  */
end_comment
begin_function
DECL|function|git_pull_config
specifier|static
name|int
name|git_pull_config
parameter_list|(
specifier|const
name|char
modifier|*
...
name|_
argument_list|(
literal|"--[no-]autostash option is only valid with --rebase."
argument_list|)
argument_list|)
expr_stmt|;
if|if
