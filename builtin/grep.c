...
end_decl_stmt
begin_define
DECL|macro|GREP_NUM_THREADS_DEFAULT
define|#
directive|define
name|GREP_NUM_THREADS_DEFAULT
value|8
end_define
begin_decl_stmt
...
name|_
argument_list|(
literal|"invalid number of threads specified (%d) for %s"
argument_list|)
argument_list|,
name|num_threads
argument_list|,
