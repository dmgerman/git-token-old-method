...
name|name
decl_stmt|;
comment|/* if type == WORK_SHA1, then 'identifier' is a SHA1, 	 * otherwise type == WORK_FILE, and 'identifier' is a NUL 	 * terminated filename. 	 */
...
specifier|static
name|int
name|print_hunk_marks_between_files
decl_stmt|;
end_decl_stmt
begin_decl_stmt
