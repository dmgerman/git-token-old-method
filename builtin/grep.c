...
specifier|static
name|void
name|grep_pattern_type_options
parameter_list|(
specifier|const
name|int
name|pattern_type
...
end_decl_stmt
begin_comment
comment|/*  * Initialize the grep_defaults template with hardcoded defaults.  * We could let the compiler do this, but without C99 initializers  * the code gets unwieldy and unreadable, so...  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*  * Read the configuration file once and store it in  * the grep_defaults template.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*  * Initialize one instance of grep_opt and copy the  * default values from the template we read the configuration  * information in an earlier call to git_config(grep_config).  */
end_comment
begin_function
