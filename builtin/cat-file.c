...
name|info
decl_stmt|;
comment|/* 	 * This flag will be true if the requested batch format and options 	 * don't require us to call sha1_object_info, which can then be 	 * optimized out. 	 */
DECL|member|skip_object_info
name|unsigned
name|skip_object_info
range|:
literal|1
decl_stmt|;
block|}
...
name|die_errno
argument_list|(
literal|"unable to write to stdout"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|die
argument_list|(
literal|"BUG: unknown get_sha1_with_context result %d\n"
argument_list|,
name|result
argument_list|)
expr_stmt|;
...
name|N_
argument_list|(
literal|"follow in-tree symlinks (used with --batch or --batch-check)"
argument_list|)
argument_list|)
block|,
name|OPT_BOOL
...
name|N_
argument_list|(
literal|"show all objects with --batch or --batch-check"
argument_list|)
argument_list|)
block|,
name|OPT_END
