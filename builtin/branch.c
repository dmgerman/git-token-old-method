...
end_function
begin_comment
comment|/*  * Allocate memory for a new ref_array_item and insert that into the  * given ref_array. Doesn't take the objectname unlike  * new_ref_array_item(). This is a temporary function which will be  * removed when we port branch.c to use ref-filter APIs.  */
end_comment
begin_function
