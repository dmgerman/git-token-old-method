...
end_function
begin_function
DECL|function|reject_rebase_or_bisect_branch
specifier|static
name|void
name|reject_rebase_or_bisect_branch
parameter_list|(
specifier|const
name|char
modifier|*
...
name|_
argument_list|(
literal|"Branch %s is being rebased at %s"
argument_list|)
argument_list|,
name|target
argument_list|,
...
name|_
argument_list|(
literal|"Branch %s is being bisected at %s"
argument_list|)
argument_list|,
name|target
argument_list|,
