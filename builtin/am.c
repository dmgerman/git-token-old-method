...
end_function
begin_comment
comment|/**  * Like parse_mail(), but parses the mail by looking up its commit ID  * directly. This is used in --rebasing mode to bypass git-mailinfo's munging  * of patches.  *  * Will always return 0 as the patch should never be skipped.  */
end_comment
begin_function
