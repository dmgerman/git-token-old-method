...
name|N_
argument_list|(
literal|"git remote get-url [--push] [--all]<name>"
argument_list|)
block|,
name|N_
argument_list|(
...
modifier|*
specifier|const
name|builtin_remote_geturl_usage
index|[]
init|=
block|{
name|N_
...
name|merge
decl_stmt|;
DECL|enumerator|NO_REBASE
DECL|enumerator|NORMAL_REBASE
DECL|enumerator|INTERACTIVE_REBASE
DECL|member|rebase
enum|enum
block|{
name|NO_REBASE
...
name|N_
argument_list|(
literal|"query push URLs rather than fetch URLs"
argument_list|)
argument_list|)
block|,
name|OPT_BOOL
...
expr_stmt|;
block|}
comment|/* else fetch mode */
comment|/* Use the fetch URL when no push URLs were found or requested. */
if|if
condition|(
operator|!
name|url_nr
...
name|_
argument_list|(
literal|"no URLs configured for remote '%s'"
argument_list|)
argument_list|,
name|remotename
argument_list|)
