...
argument_list|)
expr_stmt|;
comment|/* 	 * "git fetch --refmap='' origin foo" 	 * can be used to tell the command not to store anywhere 	 */
if|if
condition|(
operator|*
name|arg
...
name|die
argument_list|(
literal|"--refmap option is only meaningful with command-line refspec(s)."
argument_list|)
expr_stmt|;
block|}
else|else
...
argument_list|)
expr_stmt|;
comment|/* Now append any refs to be updated opportunistically: */
operator|*
name|tail
operator|=
name|orefs
...
name|_
argument_list|(
literal|"reject %s because shallow roots are not allowed to be updated"
argument_list|)
argument_list|,
name|rm
operator|->
...
condition|)
block|{
comment|/* 		 * We only prune based on refspecs specified 		 * explicitly (via command line or configuration); we 		 * don't care whether --tags was specified. 		 */
if|if
condition|(
name|ref_count
condition|)
...
name|xstrfmt
argument_list|(
literal|"refs/tags/%s:refs/tags/%s"
argument_list|,
name|argv
index|[
name|i
