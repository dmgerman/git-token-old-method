...
name|var
argument_list|,
literal|"repack.packkeptobjects"
argument_list|)
condition|)
block|{
name|pack_kept_objects
...
name|N_
argument_list|(
literal|"repack objects in packs marked with .keep"
argument_list|)
argument_list|)
block|,
name|OPT_END
