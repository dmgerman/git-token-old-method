...
specifier|const
name|char
name|reflog_exists_usage
index|[]
init|=
literal|"git reflog exists<ref>"
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
index|[]
init|=
literal|"git reflog [ show | expire | delete | exists ]"
decl_stmt|;
end_decl_stmt
begin_function
