...
name|die_errno
argument_list|(
literal|"%s: sha1 file read error"
argument_list|,
name|f
operator|->
name|name
...
name|die
argument_list|(
literal|"sha1 file '%s' validation error"
argument_list|,
name|f
operator|->
name|name
...
name|die_errno
argument_list|(
literal|"%s: error when reading the tail of sha1 file"
argument_list|,
name|f
operator|->
name|name
...
name|die
argument_list|(
literal|"%s: sha1 file has trailing garbage"
argument_list|,
name|f
operator|->
name|name
...
literal|0
expr_stmt|;
comment|/* sha1flush() was called in checkpoint */
return|return
literal|0
return|;
block|}
