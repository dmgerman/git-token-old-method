...
end_function
begin_function
DECL|function|process_lock_header
name|size_t
name|process_lock_header
parameter_list|(
name|void
modifier|*
name|ptr
...
name|ptr
argument_list|,
literal|"Lock-Token:<opaquelocktoken:"
argument_list|,
literal|29
argument_list|)
condition|)
...
name|stderr
argument_list|,
literal|"Unable to unlock, no lock token"
argument_list|)
expr_stmt|;
return|return
literal|0
