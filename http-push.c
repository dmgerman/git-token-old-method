...
name|current_time
decl_stmt|;
comment|/* Refresh all active locks if they're close to expiring */
for|for
control|(
name|lock
operator|=
...
end_function_decl
begin_function
DECL|function|handle_crawl_ref_ctx
specifier|static
name|void
name|handle_crawl_ref_ctx
parameter_list|(
name|struct
name|xml_ctx
modifier|*
...
end_function
begin_function
DECL|function|handle_remote_object_list_ctx
specifier|static
name|void
name|handle_remote_object_list_ctx
parameter_list|(
name|struct
name|xml_ctx
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Make sure the url is not already locked */
while|while
condition|(
name|lock
operator|&&
...
end_function
begin_function
DECL|function|crawl_remote_refs
specifier|static
name|void
name|crawl_remote_refs
parameter_list|(
