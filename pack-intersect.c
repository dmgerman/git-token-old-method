...
end_comment
begin_function
DECL|function|llist_sorted_difference
name|struct
name|llist
modifier|*
name|llist_sorted_difference
parameter_list|(
name|struct
name|llist_item
modifier|*
...
condition|)
block|{
comment|/* we'll never find this B */
name|B
operator|=
name|B
operator|->
...
continue|continue;
block|}
comment|/* A has the object, B doesn't */
name|llist_insert_back
argument_list|(
name|ret
argument_list|,
...
argument_list|)
condition|)
comment|/* this will silently ignore packs in alt-odb */
return|return
name|add_pack
argument_list|(
name|p
...
name|pack_local
condition|)
comment|/* ignore alt-odb for now */
name|add_pack
argument_list|(
name|p
argument_list|)
