...
name|die
argument_list|(
literal|"BUG: get_lock_file_path() called for unlocked object"
argument_list|)
expr_stmt|;
return|return
name|lk
...
name|die
argument_list|(
literal|"BUG: get_lock_file_fd() called for unlocked object"
argument_list|)
expr_stmt|;
return|return
name|lk
...
name|die
argument_list|(
literal|"BUG: get_lock_file_fp() called for unlocked object"
argument_list|)
expr_stmt|;
return|return
name|lk
