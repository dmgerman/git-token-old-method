...
condition|)
comment|/* in GNU grep git's "-z" translates to "-Z" */
name|push_arg
argument_list|(
literal|"-Z"
argument_list|)
...
name|external_grep_allowed
argument_list|,
literal|"allow calling of grep(1) (default)"
argument_list|)
block|,
endif|#
directive|endif
