...
specifier|static
name|int
name|run_post_upload_pack_hook
parameter_list|(
name|size_t
name|total
parameter_list|,
...
index|]
operator|=
literal|"hooks/post-upload-pack"
expr_stmt|;
name|argv
index|[
literal|1
...
argument_list|)
expr_stmt|;
comment|/* pass on revisions we (don't) want */
if|if
condition|(
operator|!
name|shallow_nr
...
name|warning
argument_list|(
literal|"post-upload-hook failed"
argument_list|)
expr_stmt|;
return|return;
name|fail
