...
name|N_
argument_list|(
literal|"git upload-pack [<options>]<dir>"
argument_list|)
block|,
name|NULL
block|}
...
end_decl_stmt
begin_decl_stmt
DECL|variable|pack_objects_hook
specifier|static
specifier|const
name|char
modifier|*
name|pack_objects_hook
decl_stmt|;
end_decl_stmt
begin_function
...
name|die
argument_list|(
literal|"'%s' is a symref but it is not?"
argument_list|,
name|refname
argument_list|)
expr_stmt|;
...
name|strcmp
argument_list|(
literal|"uploadpack.packobjectshook"
argument_list|,
name|var
argument_list|)
condition|)
...
name|N_
argument_list|(
literal|"quit after a single request/response exchange"
argument_list|)
argument_list|)
block|,
name|OPT_BOOL
...
name|N_
argument_list|(
literal|"do not try<directory>/.git/ if<directory> is no Git directory"
argument_list|)
argument_list|)
block|,
name|OPT_INTEGER
...
name|N_
argument_list|(
literal|"interrupt transfer after<n> seconds of inactivity"
argument_list|)
argument_list|)
block|,
name|OPT_END
