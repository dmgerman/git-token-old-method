...
name|subcnt
expr_stmt|;
comment|/* to be used in the next loop */
operator|*
name|skip_count
operator|+=
name|subskip
...
return|;
block|}
comment|/* 		 * CE_REMOVE entries are removed before the index is 		 * written to disk. Skip them to remain consistent 		 * with the future on-disk index. 		 */
if|if
condition|(
name|ce
operator|->
...
name|cache_tree
modifier|*
name|find_cache_tree_from_traversal
parameter_list|(
name|struct
name|cache_tree
modifier|*
