...
expr_stmt|;
block|}
comment|/* 		 * Count lines added at the end of the file. 		 * This is not enough to get things right in case of 		 * patches generated with --unified=0, but it's a 		 * useful upper bound. 		*/
if|if
condition|(
name|first
operator|==
...
condition|)
block|{
comment|/* Any added empty lines is already cleaned-up here 		 * becuase of 'strip_whitespace' flag, so just count '\n' 		*/
name|int
name|empty
init|=
literal|0
...
operator|--
expr_stmt|;
comment|/* these are the empty lines added at 		 * the end of the file, modulo u0 patches. 		 */
name|trailing_added_lines
operator|=
name|empty
expr_stmt|;
