...
end_comment
begin_comment
comment|//  --show-index-info shows the old and new index info for paths if available.
end_comment
begin_comment
comment|//
end_comment
...
index|[]
init|=
literal|"git-apply [--stat] [--summary] [--check] [--index] [--apply] [--show-files] [--show-index-info]<patch>..."
decl_stmt|;
end_decl_stmt
begin_comment
