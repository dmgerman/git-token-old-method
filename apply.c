...
index|[]
init|=
literal|"git-apply [--stat] [--numstat] [--summary] [--check] [--index] [--apply] [--no-add] [--index-info] [--allow-binary-replacement] [-z] [-pNUM] [-CNUM] [--whitespace=<nowarn|warn|error|error-all|strip>]<patch>..."
decl_stmt|;
end_decl_stmt
begin_enum
...
argument_list|)
expr_stmt|;
comment|/* Grab the type of patch */
name|llen
operator|=
name|linelen
argument_list|(
...
name|error
argument_list|(
literal|"unrecognized binary patch at line %d: %.*s"
argument_list|,
name|linenr
operator|-
literal|1
...
name|stderr
argument_list|,
literal|"Context reduced to (%ld/%ld) to apply fragment at %d\n"
argument_list|,
name|leading
argument_list|,
name|trailing
...
name|stderr
argument_list|,
literal|"warning: squelched %d whitespace error%s\n"
argument_list|,
name|squelched
argument_list|,
name|squelched
