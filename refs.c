...
condition|)
block|{
comment|/* The ref did not exist and we are creating it. 		 * Make sure there is no existing ref that is packed 		 * whose name begins with our refname, nor a ref whose 		 * name is a proper prefix of our refname. 		 */
name|int
name|namlen
init|=
name|strlen
