...
argument_list|)
expr_stmt|;
comment|/* Remove any duplicates from the ref_array */
name|i
operator|=
literal|0
expr_stmt|;
...
end_function
begin_comment
comment|/*  * Call fn for each reference in array that has index in the range  * offset<= index< array->nr.  This function does not sort the  * array; sorting should be done by the caller.  */
end_comment
begin_function
DECL|function|do_for_each_ref_in_array
specifier|static
name|int
name|do_for_each_ref_in_array
parameter_list|(
name|struct
name|ref_array
modifier|*
...
end_function
begin_comment
comment|/*  * Call fn for each reference in the union of array1 and array2, in  * order by refname.  If an entry appears in both array1 and array2,  * then only process the version that is in array2.  The input arrays  * must already be sorted.  */
end_comment
begin_function
DECL|function|do_for_each_ref_in_arrays
specifier|static
name|int
name|do_for_each_ref_in_arrays
parameter_list|(
name|struct
name|ref_array
modifier|*
