...
name|die
argument_list|(
literal|"Reference has invalid name: '%s'"
argument_list|,
name|refname
argument_list|)
expr_stmt|;
...
end_function
begin_comment
comment|/*  * Write sha1 into the open lockfile, then close the lockfile. On  * errors, rollback the lockfile and set errno to reflect the problem.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*  * Write sha1 as the new value of the reference specified by the  * (open) lock. On error, roll back the lockfile and set errno  * appropriately.  */
end_comment
begin_function
...
name|err
argument_list|,
literal|"refusing to create ref with bad name %s"
argument_list|,
name|refname
argument_list|)
expr_stmt|;
