...
parameter_list|)
block|{
comment|/* 	 * This is really not the right way to do it, but 	 * add_file_to_cache() does do the right thing. 	 * 	 * We should really just update the cache 	 * entry in-place, I think. With this approach we 	 * end up allocating a new one, searching for where 	 * to insert it etc etc crud. 	 */
name|add_file_to_cache
argument_list|(
name|ce
operator|->
