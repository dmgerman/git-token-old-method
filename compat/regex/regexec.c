...
end_function
begin_decl_stmt
DECL|variable|length1
DECL|variable|length2
DECL|variable|start
DECL|variable|stop
name|int
name|length1
...
name|out_free
goto|;
comment|/* Avoid arithmetic overflow in size calculation.  */
if|if
condition|(
name|BE
argument_list|(
