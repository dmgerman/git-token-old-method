...
comment|'#'
nl|'\n'
comment|'# This module should remain compatible with Python 2.2, see PEP 291.'
nl|'\n'
comment|'#'
nl|'\n'
comment|'# Copyright (c) 2003-2005 by Peter Astrand <astrand@lysator.liu.se>'
nl|'\n'
comment|'#'
nl|'\n'
comment|'# Licensed to PSF under a Contributor Agreement.'
nl|'\n'
comment|'# See http://www.python.org/2.4/license for licensing details.'
nl|'\n'
nl|'\n'
...
newline|'\n'
indent|'            '
string|'"""Construct and return tuple with IO objects:\n            p2cread, p2cwrite, c2pread, c2pwrite, errread, errwrite\n            """'
newline|'\n'
name|'if'
name|'stdin'
op|'=='
...
newline|'\n'
indent|'            '
string|'"""Find and return absolute path to w9xpopen.exe"""'
newline|'\n'
name|'w9xpopen'
op|'='
name|'os'
