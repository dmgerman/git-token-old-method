...
argument_list|)
expr_stmt|;
comment|/* find set of paths that everybody touches 	 * 	 * NOTE find_paths() also handles --stat, as it computes 	 * diff(sha1,parent_i) for all i to do the job, specifically 	 * for parent0. 	 */
name|paths
operator|=
name|find_paths
argument_list|(
