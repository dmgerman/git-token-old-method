...
end_function
begin_comment
comment|/* Take a raw path from is_git_repo() and canonicalize it using Linus'  * idea of a blind chdir() and getcwd(). */
end_comment
begin_function
...
return|;
block|}
comment|/* This is perfectly safe, and people tend to think of the directory 	 * where they ran git-init-db as their repository, so humour them. */
operator|(
name|void
operator|)
name|chdir
