...
literal|1
decl_stmt|;
comment|/* The first paragraph is the title and cannot be trailers */
for|for
control|(
name|start
operator|=
...
end_function
begin_comment
comment|/* Get the index of the end of the trailers */
end_comment
begin_function
DECL|function|find_trailer_end
specifier|static
name|int
name|find_trailer_end
parameter_list|(
name|struct
name|strbuf
modifier|*
...
end_function
begin_decl_stmt
DECL|variable|trailers_tempfile
specifier|static
name|struct
name|tempfile
name|trailers_tempfile
decl_stmt|;
end_decl_stmt
begin_function
DECL|function|create_in_place_tempfile
specifier|static
name|FILE
modifier|*
name|create_in_place_tempfile
parameter_list|(
specifier|const
name|char
modifier|*
...
name|_
argument_list|(
literal|"file %s is not a regular file"
argument_list|)
argument_list|,
name|file
argument_list|)
...
name|_
argument_list|(
literal|"file %s is not writable by user"
argument_list|)
argument_list|,
name|file
argument_list|)
expr_stmt|;
comment|/* Create temporary file in the same directory as the original */
name|tail
operator|=
name|strrchr
argument_list|(
...
name|template
argument_list|,
literal|"git-interpret-trailers-XXXXXX"
argument_list|)
expr_stmt|;
...
name|_
argument_list|(
literal|"could not rename temporary file to %s"
argument_list|)
argument_list|,
name|file
argument_list|)
