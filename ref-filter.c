...
name|align
decl_stmt|;
DECL|enumerator|RR_NORMAL
DECL|enumerator|RR_SHORTEN
DECL|enumerator|RR_TRACK
DECL|enumerator|RR_TRACKSHORT
enum|enum
block|{
name|RR_NORMAL
block|,
...
struct|struct
block|{
DECL|enumerator|C_BARE
DECL|enumerator|C_BODY
DECL|enumerator|C_BODY_DEP
DECL|enumerator|C_LINES
DECL|enumerator|C_SIG
DECL|enumerator|C_SUB
DECL|member|option
enum|enum
block|{
name|C_BARE
...
name|contents
struct|;
DECL|enumerator|O_FULL
DECL|enumerator|O_SHORT
...
end_decl_stmt
begin_function
DECL|function|color_atom_parser
specifier|static
name|void
name|color_atom_parser
parameter_list|(
name|struct
name|used_atom
modifier|*
...
name|_
argument_list|(
literal|"unrecognized color: %%(color:%s)"
argument_list|)
argument_list|,
name|color_value
argument_list|)
...
end_function
begin_function
DECL|function|remote_ref_atom_parser
specifier|static
name|void
name|remote_ref_atom_parser
parameter_list|(
name|struct
name|used_atom
modifier|*
...
end_function
begin_function
DECL|function|body_atom_parser
specifier|static
name|void
name|body_atom_parser
parameter_list|(
name|struct
name|used_atom
modifier|*
...
end_function
begin_function
DECL|function|subject_atom_parser
specifier|static
name|void
name|subject_atom_parser
parameter_list|(
name|struct
name|used_atom
modifier|*
...
end_function
begin_function
DECL|function|contents_atom_parser
specifier|static
name|void
name|contents_atom_parser
parameter_list|(
name|struct
name|used_atom
modifier|*
...
name|_
argument_list|(
literal|"positive value expected contents:lines=%s"
argument_list|)
argument_list|,
name|arg
argument_list|)
...
name|_
argument_list|(
literal|"unrecognized %%(contents) argument: %s"
argument_list|)
argument_list|,
name|arg
argument_list|)
...
end_function
begin_function
DECL|function|objectname_atom_parser
specifier|static
name|void
name|objectname_atom_parser
parameter_list|(
name|struct
name|used_atom
modifier|*
...
name|_
argument_list|(
literal|"unrecognized %%(objectname) argument: %s"
argument_list|)
argument_list|,
name|arg
argument_list|)
...
end_function
begin_function
DECL|function|parse_align_position
specifier|static
name|align_type
name|parse_align_position
parameter_list|(
specifier|const
name|char
modifier|*
...
end_function
begin_function
DECL|function|align_atom_parser
specifier|static
name|void
name|align_atom_parser
parameter_list|(
name|struct
name|used_atom
modifier|*
...
name|_
argument_list|(
literal|"unrecognized position:%s"
argument_list|)
argument_list|,
name|s
argument_list|)
...
name|_
argument_list|(
literal|"unrecognized %%(align) argument: %s"
argument_list|)
argument_list|,
name|s
argument_list|)
...
name|die
argument_list|(
literal|"BUG: unknown %%(objectname) option"
argument_list|)
expr_stmt|;
block|}
return|return
...
end_function
begin_comment
comment|/*  * If 'lines' is greater than 0, append that many lines from the given  * 'buf' of length 'size' to the given strbuf.  */
end_comment
begin_function
...
name|siglen
decl_stmt|;
comment|/*  Size is the length of the message after removing the signature */
name|append_lines
argument_list|(
operator|&
name|s
...
end_function
begin_function
DECL|function|strip_ref_components
specifier|static
specifier|const
name|char
modifier|*
name|strip_ref_components
parameter_list|(
specifier|const
name|char
modifier|*
...
end_function
begin_function
DECL|function|fill_remote_ref_details
specifier|static
name|void
name|fill_remote_ref_details
parameter_list|(
name|struct
name|used_atom
modifier|*
...
end_function
begin_comment
comment|/*  * Return 1 if the refname matches one of the patterns, otherwise 0.  * A pattern can be a literal prefix (e.g. a refname "refs/heads/master"  * matches a pattern "refs/heads/mas") or a wildcard (e.g. the same ref  * matches "refs/heads/mas*", too).  */
end_comment
begin_function
...
parameter_list|)
block|{
comment|/* 	 * When no '--format' option is given we need to skip the prefix 	 * for matching refs of tags and branches. 	 */
call|(
name|void
call|)
argument_list|(
...
end_function
begin_comment
comment|/*  * Return 1 if the refname matches one of the patterns, otherwise 0.  * A pattern can be path prefix (e.g. a refname "refs/heads/master"  * matches a pattern "refs/heads/" but not "refs/heads/m") or a  * wildcard (e.g. the same ref matches "refs/heads/m*", too).  */
end_comment
begin_function
...
end_function
begin_comment
comment|/* Return 1 if the refname matches one of the patterns, otherwise 0. */
end_comment
begin_function
DECL|function|filter_pattern_match
specifier|static
name|int
name|filter_pattern_match
parameter_list|(
name|struct
name|ref_filter
modifier|*
...
return|;
block|}
comment|/* Obtain the current ref kind from filter_ref_kind() and ignore unwanted refs. */
name|kind
operator|=
name|filter_ref_kind
argument_list|(
...
block|{
comment|/* 		 * For common cases where we need only branches or remotes or tags, 		 * we only iterate through those refs. If a mix of refs is needed, 		 * we iterate over all refs and filter out required refs with the help 		 * of filter_ref_kind(). 		 */
if|if
condition|(
name|filter
operator|->
