...
condition|)
block|{
comment|/* is this the first of the run of comments? */
if|if
condition|(
operator|!
name|boc
...
name|bol
expr_stmt|;
comment|/* otherwise, it is just continuing */
block|}
elseif|else
if|if
condition|(
...
block|{
empty_stmt|;
comment|/* a pathname in the conflicts block */
block|}
elseif|else
if|if
condition|(
...
condition|)
block|{
comment|/* the previous was not trailing comment */
name|boc
operator|=
literal|0
expr_stmt|;
