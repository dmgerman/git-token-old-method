...
name|buf_p
expr_stmt|;
comment|/* 	 * We do not want to repeatedly realloc below, so 	 * preallocate with enough slop to hold MIME headers, 	 * "Subject: " prefix, etc. 	 */
name|slop
operator|=
literal|1000
expr_stmt|;
...
condition|)
break|break;
comment|/* 20 would cover indent and leave us some slop */
if|if
condition|(
name|offset
operator|+
