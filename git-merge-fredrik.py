...
newline|'\n'
nl|'\n'
DECL|variable|alwaysWriteTree
name|'alwaysWriteTree'
op|'='
name|'False'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|"# cleanCache == True  => Don't leave any non-stage 0 entries in the cache."
nl|'\n'
comment|'#               False => Leave unmerged entries'
nl|'\n'
nl|'\n'
comment|'# updateWd  == True  => Update the working directory to correspond to the cache'
nl|'\n'
comment|'#              False => Leave the working directory unchanged'
nl|'\n'
nl|'\n'
...
newline|'\n'
name|'print'
string|"'CONFLICT: but permissions conflict'"
op|','
string|"'0%o'"
op|'%'
name|'aMode'
...
indent|'        '
name|'print'
string|"'ERROR: Fatal merge failure.'"
newline|'\n'
name|'print'
...
indent|'    '
name|'print'
string|"'Automatic merge failed, fix up by hand'"
newline|'\n'
name|'sys'
op|'.'
name|'exit'
