...
end_struct
begin_comment
comment|/*  * Test performance of hash.[ch]  * Usage: time echo "perfhash method rounds" | test-hashmap  */
end_comment
begin_function
