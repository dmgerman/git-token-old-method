...
end_function
begin_comment
comment|/*  * level == 0: mark all overlapping changes as conflict  * level == 1: mark overlapping changes as conflict only if not identical  * level == 2: analyze non-identical changes for minimal conflict set  *  * returns< 0 on error, == 0 for no conflicts, else number of conflicts  */
end_comment
begin_function
