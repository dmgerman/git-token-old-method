...
name|i2
decl_stmt|;
comment|/* 				 * We don't need additional context if 				 * a whole function was added, possibly 				 * starting with empty lines. 				 */
while|while
condition|(
name|i2
operator|<
...
condition|)
goto|goto
name|post_context_calculation
goto|;
comment|/* 				 * Otherwise get more context from the 				 * pre-image. 				 */
name|i1
operator|=
name|xe
operator|->
