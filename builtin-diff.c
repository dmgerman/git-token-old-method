...
condition|)
block|{
comment|/* 		 * Perhaps the user gave us A...B, which expands 		 * to a list of negative merge bases followed by 		 * A (symmetric-left) and B?  Let's make sure... 		 */
for|for
control|(
name|i
operator|=
...
name|die
argument_list|(
literal|"what do you mean by that?"
argument_list|)
expr_stmt|;
