...
expr_stmt|;
block|}
comment|/* 	 * Make sure there are NO revision (i.e. pending object) parameter, 	 * specified rev.max_count is reasonable (0<= n<= 3), and 	 * there is no other revision filtering parameter. 	 */
if|if
condition|(
name|revs
operator|->
...
expr_stmt|;
block|}
comment|/* We saw two trees, ent[0] and ent[1]. 	 * unless ent[0] is unintesting, they are swapped 	 */
if|if
condition|(
name|ent
index|[
