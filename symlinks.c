...
expr_stmt|;
block|}
comment|/* 	 * Is the cached path string a substring of 'name', is 'name' 	 * a substring of the cached path string, or is 'name' and the 	 * cached path string the exact same string? 	 */
if|if
condition|(
name|i
operator|>=
