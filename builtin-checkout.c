...
end_function
begin_comment
comment|/*  * We really should allow cb_data... Yuck  */
end_comment
begin_decl_stmt
...
condition|)
block|{
comment|/* 		 * Yeah, I know Christian's clean-up should 		 * be used here, but the topic is based on an 		 * older fork point. 		 */
if|if
condition|(
operator|!
name|value
...
argument_list|)
expr_stmt|;
comment|/* 	 * Ok, it is tracking base; is it ahead of us? 	 */
if|if
condition|(
operator|!
name|resolve_ref
...
name|msgfmt
operator|=
literal|"You are ahead of the tracked branch '%s'\n"
expr_stmt|;
name|show_log
operator|=
literal|0
...
name|msgfmt
operator|=
literal|"Your branch can be fast-forwarded to the tracked branch '%s'\n"
expr_stmt|;
else|else
name|msgfmt
operator|=
literal|"Both your branch and the tracked branch '%s' have own changes, you would eventually need to merge\n"
expr_stmt|;
if|if
condition|(
operator|!
