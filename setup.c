...
end_function
begin_comment
comment|/*  * A "string_list_each_func_t" function that canonicalizes an entry  * from GIT_CEILING_DIRECTORIES using real_path_if_valid(), or  * discards it if unusable.  */
end_comment
begin_function
