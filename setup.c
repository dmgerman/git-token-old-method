...
name|buf
expr_stmt|;
comment|/* 	 * Ignore return value; for historical reasons, we must treat a missing 	 * config file as a noop (git-init relies on this). 	 */
...
name|die
argument_list|(
literal|"unknown repository extension: %s"
argument_list|,
name|unknown_extensions
operator|.
name|items
