...
end_function
begin_comment
comment|/*  * Magic pathspec  *  * NEEDSWORK: These need to be moved to dir.h or even to a new  * pathspec.h when we restructure get_pathspec() users to use the  * "struct pathspec" interface.  *  * Possible future magic semantics include stuff like:  *  *	{ PATHSPEC_NOGLOB, '!', "noglob" },  *	{ PATHSPEC_RECURSIVE, '*', "recursive" },  *	{ PATHSPEC_REGEXP, '\0', "regexp" },  *  */
end_comment
begin_define
