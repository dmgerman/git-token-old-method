...
directive|endif
comment|/* LIBCURL_VERSION_NUM>= 0x070a08 */
block|}
else|else
block|{
return|return
...
name|eol
decl_stmt|;
comment|/* 	 * We only show text/plain parts, as other types are likely 	 * to be ugly to look at on the user's terminal. 	 */
if|if
condition|(
name|strcmp
argument_list|(
