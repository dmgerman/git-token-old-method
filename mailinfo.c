...
end_define
begin_comment
comment|/* First lines of body can have From:, Date:, and Subject: */
end_comment
begin_function
...
name|stderr
argument_list|,
literal|"tried to convert from %s to %s, "
literal|"but your iconv does not work with it.\n"
argument_list|,
name|input_charset
argument_list|,
name|metainfo_charset
...
literal|1
expr_stmt|;
comment|/* no more inbody headers */
name|line
index|[
name|len
index|]
