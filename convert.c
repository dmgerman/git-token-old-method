...
end_comment
begin_comment
comment|/* Stat bits: When BIN is set, the txt bits are unset */
end_comment
begin_define
DECL|macro|CONVERT_STAT_BITS_TXT_LF
define|#
directive|define
name|CONVERT_STAT_BITS_TXT_LF
value|0x1
end_define
begin_define
DECL|macro|CONVERT_STAT_BITS_TXT_CRLF
define|#
directive|define
name|CONVERT_STAT_BITS_TXT_CRLF
value|0x2
end_define
begin_define
DECL|macro|CONVERT_STAT_BITS_BIN
define|#
directive|define
name|CONVERT_STAT_BITS_BIN
value|0x4
end_define
begin_enum
...
name|crlf_action
block|{
DECL|enumerator|CRLF_UNDEFINED
name|CRLF_UNDEFINED
block|,
...
name|CRLF_TEXT
block|,
DECL|enumerator|CRLF_TEXT_INPUT
name|CRLF_TEXT_INPUT
block|,
DECL|enumerator|CRLF_TEXT_CRLF
name|CRLF_TEXT_CRLF
block|,
DECL|enumerator|CRLF_AUTO
name|CRLF_AUTO
block|,
DECL|enumerator|CRLF_AUTO_INPUT
name|CRLF_AUTO_INPUT
block|,
DECL|enumerator|CRLF_AUTO_CRLF
name|CRLF_AUTO_CRLF
block|}
enum|;
end_enum
...
end_function
begin_comment
comment|/*  * The same heuristics as diff.c::mmfile_is_binary()  * We treat files with bare CR as binary  */
end_comment
begin_function
DECL|function|convert_is_binary
specifier|static
name|int
...
end_function
begin_function
DECL|function|gather_convert_stats
specifier|static
name|unsigned
name|int
name|gather_convert_stats
parameter_list|(
specifier|const
name|char
modifier|*
...
end_function
begin_function
DECL|function|gather_convert_stats_ascii
specifier|static
specifier|const
name|char
modifier|*
name|gather_convert_stats_ascii
parameter_list|(
specifier|const
name|char
modifier|*
...
end_function
begin_function
DECL|function|get_cached_convert_stats_ascii
specifier|const
name|char
modifier|*
name|get_cached_convert_stats_ascii
parameter_list|(
specifier|const
name|char
modifier|*
...
end_function
begin_function
DECL|function|get_wt_convert_stats_ascii
specifier|const
name|char
modifier|*
...
end_function
begin_function
DECL|function|text_eol_is_crlf
specifier|static
name|int
name|text_eol_is_crlf
parameter_list|(
name|void
parameter_list|)
block|{
...
argument_list|)
expr_stmt|;
comment|/* Optimization: No CRLF? Nothing to convert, regardless. */
if|if
condition|(
operator|!
name|stats
...
argument_list|)
expr_stmt|;
comment|/* No "naked" LF? Nothing to convert, regardless. */
if|if
condition|(
operator|!
name|stats
...
name|drv
decl_stmt|;
DECL|member|attr_action
name|enum
name|crlf_action
name|attr_action
decl_stmt|;
comment|/* What attr says */
DECL|member|crlf_action
name|enum
name|crlf_action
name|crlf_action
decl_stmt|;
comment|/* When no attr is set, use core.autocrlf */
DECL|member|ident
name|int
name|ident
decl_stmt|;
...
name|int
name|would_convert_to_git_filter_fd
parameter_list|(
specifier|const
name|char
modifier|*
...
literal|0
return|;
comment|/* 	 * Apply a filter to an fd only if the filter is required to succeed. 	 * We must die if the filter fails, because the original data before 	 * filtering is not available. 	 */
if|if
condition|(
operator|!
name|ca
...
end_function
begin_function
DECL|function|get_convert_attr_ascii
specifier|const
name|char
modifier|*
name|get_convert_attr_ascii
parameter_list|(
specifier|const
name|char
modifier|*
