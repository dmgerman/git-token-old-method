...
end_comment
begin_comment
comment|/* changes that can be kept in $GIT_DIR/index (basically all extensions) */
end_comment
begin_define
DECL|macro|EXTMASK
define|#
directive|define
name|EXTMASK
value|(RESOLVE_UNDO_CHANGED | CACHE_TREE_CHANGED | \ 		 CE_ENTRY_ADDED | CE_ENTRY_REMOVED | CE_ENTRY_CHANGED | \ 		 SPLIT_INDEX_ORDERED | UNTRACKED_CHANGED)
end_define
begin_decl_stmt
...
name|_
argument_list|(
literal|"index.version set, but the value is invalid.\n"
literal|"Using version %i"
argument_list|)
argument_list|,
name|INDEX_FORMAT_DEFAULT
argument_list|)
...
name|_
argument_list|(
literal|"GIT_INDEX_VERSION set, but the value is invalid.\n"
literal|"Using version %i"
argument_list|)
argument_list|,
name|INDEX_FORMAT_DEFAULT
...
name|die
argument_list|(
literal|"unordered stage entries in index"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die
argument_list|(
literal|"multiple stage entries for merged file '%s'"
argument_list|,
name|ce
operator|->
name|name
...
name|die
argument_list|(
literal|"unordered stage entries for '%s'"
argument_list|,
name|ce
operator|->
name|name
...
end_function
begin_function
DECL|function|tweak_untracked_cache
specifier|static
name|void
name|tweak_untracked_cache
parameter_list|(
name|struct
name|index_state
modifier|*
...
break|break;
default|default:
comment|/* unknown value: do nothing */
break|break;
block|}
block|}
end_function
begin_function
DECL|function|post_read_index_from
specifier|static
name|void
name|post_read_index_from
parameter_list|(
name|struct
name|index_state
modifier|*
...
name|die_errno
argument_list|(
literal|"%s: index file open failed"
argument_list|,
name|path
argument_list|)
expr_stmt|;
...
name|ret
decl_stmt|;
comment|/* istate->initialized covers both .git/index and .git/sharedindex.xxx */
if|if
condition|(
name|istate
operator|->
...
name|die
argument_list|(
literal|"broken index, expect %s in %s, got %s"
argument_list|,
name|sha1_to_hex
argument_list|(
name|split_index
...
end_function
begin_comment
comment|/*  * This function verifies if index_state has the correct sha1 of the  * index file.  Don't die if we have any other failure, just return 0.  */
end_comment
begin_function
DECL|function|verify_index_from
specifier|static
name|int
name|verify_index_from
parameter_list|(
specifier|const
name|struct
name|index_state
