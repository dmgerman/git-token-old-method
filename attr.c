...
name|GIT_PATH_FUNC
argument_list|(
argument|git_path_info_attributes
argument_list|,
argument|INFOATTRIBUTES_FILE
argument_list|)
...
end_function
begin_comment
comment|/*  * Collect attributes for path into the array pointed to by  * check_all_attr. If num is non-zero, only attributes in check[] are  * collected. Otherwise all attributes are collected.  */
end_comment
begin_function
DECL|function|collect_some_attrs
specifier|static
name|void
name|collect_some_attrs
parameter_list|(
specifier|const
name|char
modifier|*
