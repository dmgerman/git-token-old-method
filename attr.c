...
end_function
begin_comment
comment|/*  * I do not like this at all.  Only because we allow individual  * attribute to be set or unset incrementally by individual  * lines in .gitattribute files, we need to do this triple  * loop which looks quite wasteful.  */
end_comment
begin_function
DECL|function|fill
specifier|static
