...
end_function
begin_comment
comment|/* parse @something syntax, when 'something' is not {.*} */
end_comment
begin_function
DECL|function|interpret_empty_at
specifier|static
name|int
name|interpret_empty_at
parameter_list|(
specifier|const
name|char
modifier|*
...
argument_list|)
decl_stmt|;
comment|/* 	 * Upstream can be NULL only if branch refers to HEAD and HEAD 	 * points to something different than a branch. 	 */
if|if
condition|(
operator|!
name|upstream
...
name|die
argument_list|(
literal|"BUG: incompatible flags for get_sha1_with_context"
argument_list|)
expr_stmt|;
return|return
name|get_sha1_with_context_1
