...
end_function
begin_comment
comment|/*  * *string and *len will only be substituted, and *string returned (for  * later free()ing) if the string passed in is of the form @{-<n>} or  * of the form<branch>@{upstream}.  */
end_comment
begin_function
...
name|die
argument_list|(
literal|"No tracking branch found for '%s'"
argument_list|,
name|ref
argument_list|)
expr_stmt|;
