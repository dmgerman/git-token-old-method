...
end_function
begin_comment
comment|/*  * This reads "@{-N}" syntax, finds the name of the Nth previous  * branch we were on, and places the name of the branch in the given  * buf and returns 0 if successful.  *  * If the input is not of the accepted format, it returns a negative  * number to signal an error.  */
end_comment
begin_function
