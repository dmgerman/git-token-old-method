...
name|generation
decl_stmt|;
comment|/* how many parents away from head_rev */
block|}
struct|;
end_struct
begin_comment
comment|/* Name the commit as nth generation ancestor of head_rev;  * we count only the first-parent relationship for naming purposes.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/* Parent is the first parent of the commit.  We may name it  * as (n+1)th generation ancestor of the same head_rev as  * commit is nth generation ancestore of, if that generation  * number is better than the name it already has.  */
end_comment
begin_function
