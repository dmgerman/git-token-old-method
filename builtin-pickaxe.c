...
control|)
block|{
comment|/* then pick each and see if they have the the correct 		 * refcnt; note that ->util caching means origin's refcnt 		 * may well be greater than the number of blame entries 		 * that use it. 		 */
name|int
name|found
decl_stmt|;
name|struct
