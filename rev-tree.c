...
name|cmit
parameter_list|)
value|((cmit)->object.flags& ~REACHABLE)
end_define
begin_decl_stmt
...
expr_stmt|;
block|}
comment|/* 	 * Parse all the commits in date order. 	 * 	 * We really should stop once we know enough, but that's a 	 * decision that isn't trivial to make. 	 */
while|while
condition|(
name|list
condition|)
