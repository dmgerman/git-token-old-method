...
end_function
begin_comment
comment|/* a return value of -1 indicates that an error occurred,  * but we were able to set individual ref errors. A return  * value of -2 means we couldn't even get that far. */
end_comment
begin_function
