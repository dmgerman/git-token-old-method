...
end_else
begin_comment
comment|/*     * Support ancient gnome-keyring, circ. RHEL 5.X.     * GNOME_KEYRING_DEFAULT seems to have been introduced with Gnome 2.22,     * and the other features roughly around Gnome 2.20, 6 months before.     * Ubuntu 8.04 used Gnome 2.22 (I think).  Not sure any distro used 2.20.     * So the existence/non-existence of GNOME_KEYRING_DEFAULT seems like     * a decent thing to use as an indicator.     */
end_comment
begin_define
...
end_define
begin_comment
comment|/*  * ancient gnome-keyring returns DENIED when an entry is not found.  * Setting NO_MATCH to DENIED will prevent us from reporting DENIED  * errors during get and erase operations, but we will still report  * DENIED errors during a store.  */
end_comment
begin_define
...
value|GNOME_KEYRING_RESULT_DENIED
end_define
begin_define
...
value|gnome_keyring_free_password
end_define
begin_define
...
return|;
case|case
name|GNOME_KEYRING_RESULT_NO_KEYRING_DAEMON
case|:
return|return
literal|"No Keyring Daemon"
return|;
case|case
name|GNOME_KEYRING_RESULT_ALREADY_UNLOCKED
case|:
return|return
literal|"Already UnLocked"
return|;
case|case
name|GNOME_KEYRING_RESULT_NO_SUCH_KEYRING
case|:
return|return
literal|"No Such Keyring"
return|;
case|case
name|GNOME_KEYRING_RESULT_BAD_ARGUMENTS
case|:
return|return
literal|"Bad Arguments"
return|;
case|case
name|GNOME_KEYRING_RESULT_IO_ERROR
case|:
return|return
literal|"IO Error"
return|;
...
return|;
case|case
name|GNOME_KEYRING_RESULT_ALREADY_EXISTS
case|:
return|return
...
end_function
begin_comment
comment|/*  * Support really ancient gnome-keyring, circ. RHEL 4.X.  * Just a guess for the Glib version.  Glib 2.8 was roughly Gnome 2.12 ?  * Which was released with gnome-keyring 0.4.3 ??  */
end_comment
begin_if
if|#
directive|if
...
block|}
decl_stmt|;
name|gnome_keyring_item_delete
argument_list|(
name|keyring
argument_list|,
name|id
