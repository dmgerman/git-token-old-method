...
nl|'\n'
comment|'# you can specify the project name and repo with config variables and'
nl|'\n'
comment|'# avoid having to modify this script.  Try it with -n to see the'
nl|'\n'
comment|'# notification mail dumped to stdout and verify that it looks'
nl|'\n'
comment|'# sane. With -V it dumps its version and exits.'
nl|'\n'
comment|'#'
nl|'\n'
...
nl|'\n'
comment|'# ciabot.project = name of the project (required)'
nl|'\n'
...
comment|'#'
nl|'\n'
comment|'# The ciabot.repo value defaults to ciabot.project lowercased.'
nl|'\n'
comment|'#'
nl|'\n'
