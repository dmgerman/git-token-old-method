...
newline|'\n'
nl|'\n'
comment|"# yep, that's hardcoded right. will fix to a commandline option rsn :)"
nl|'\n'
DECL|variable|prefix
name|'prefix'
op|'='
string|'"//depot/qt/main/"'
newline|'\n'
comment|"# that's in revision range syntax, for example @2342,523634"
nl|'\n'
