...
newline|'\n'
nl|'\n'
comment|"# replaces everything between 'Description:' and the next P4 submit template field with the"
nl|'\n'
...
op|':'
newline|'\n'
comment|"# remove lines in the Files section that show changes to files outside the depot path we're committing into"
nl|'\n'
indent|'        '
name|'template'
op|'='
...
name|'submitTemplate'
op|'+='
string|'"######## Use git-p4 option --preserve-user to modify authorship\\n"'
newline|'\n'
name|'submitTemplate'
op|'+='
string|'"######## Use git-p4 config git-p4.skipUserNameCheck hides this message.\\n"'
newline|'\n'
nl|'\n'
dedent|''
name|'separatorLine'
...
name|'print'
op|'('
string|'"Perforce submit template written as %s. "'
nl|'\n'
op|'+'
string|'"Please review/edit and then use p4 submit -i < %s to submit directly!"'
nl|'\n'
op|'%'
op|'('
name|'fileName'
...
nl|'\n'
comment|'# does not have any existing git-p4 branches'
nl|'\n'
indent|'                '
name|'if'
name|'len'
