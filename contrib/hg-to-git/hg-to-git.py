...
op|':'
newline|'\n'
comment|'# The behavior of the pickle module changed significantly in 2.3'
nl|'\n'
indent|'   '
name|'sys'
op|'.'
...
name|'write'
op|'('
string|'"hg-to-git.py: requires Python 2.3 or later.\\n"'
op|')'
newline|'\n'
name|'sys'
op|'.'
...
name|'env'
op|'+='
string|'\'export GIT_COMMITTER_NAME="%s" ;\''
op|'%'
name|'elems'
op|'.'
name|'group'
...
name|'env'
op|'+='
string|'\'export GIT_COMMITTER_EMAIL="%s" ;\''
op|'%'
name|'elems'
op|'.'
name|'group'
...
name|'env'
op|'+='
string|"'export GIT_COMMITTER_EMAIL= ;'"
newline|'\n'
nl|'\n'
dedent|''
name|'env'
