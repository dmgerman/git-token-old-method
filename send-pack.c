...
name|die_errno
argument_list|(
literal|"error writing to pack-objects"
argument_list|)
expr_stmt|;
name|fclose
argument_list|(
...
name|die
argument_list|(
literal|"the receiving end asked to sign an invalid nonce<%.*s>"
argument_list|,
name|len
argument_list|,
name|nonce
...
name|_
argument_list|(
literal|"not sending a push certificate since the"
literal|" receiving end does not support --signed"
literal|" push"
argument_list|)
argument_list|)
expr_stmt|;
