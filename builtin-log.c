...
argument_list|)
expr_stmt|;
comment|/* 		 * Replace characters at the end with the suffix if the 		 * filename is too long 		 */
if|if
condition|(
name|buf
operator|->
...
condition|)
block|{
comment|/* 		 * We fake a commit for the cover letter so we get the filename 		 * desired. 		 */
name|commit
operator|=
name|xcalloc
argument_list|(
...
expr_stmt|;
block|}
comment|/* We can't generate a cover letter without any patches */
if|if
condition|(
operator|!
name|head
