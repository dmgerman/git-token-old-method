...
name|die
argument_list|(
literal|"BUG: dashless options don't support arguments"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die
argument_list|(
literal|"BUG: dashless options don't support negation"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die
argument_list|(
literal|"BUG: dashless options can't be long"
argument_list|)
expr_stmt|;
if|if
condition|(
...
break|break;
default|default:
comment|/* OPTION_{BIT,BOOLEAN,NUMBER,SET_INT,SET_PTR} */
break|break;
block|}
if|if
condition|(
