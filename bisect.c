...
end_function
begin_comment
comment|/*  * This function runs the command "git rev-list $_good ^$_bad"  * and returns 1 if it produces some output, 0 otherwise.  */
end_comment
begin_function
...
name|die
argument_list|(
literal|"Could not launch 'git rev-list' command."
argument_list|)
expr_stmt|;
name|rls_fout
operator|=
