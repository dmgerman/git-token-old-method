...
name|GIT_PATH_FUNC
argument_list|(
argument|git_path_bisect_names
argument_list|,
...
name|GIT_PATH_FUNC
argument_list|(
argument|git_path_bisect_expected_rev
argument_list|,
...
argument_list|(
argument|struct argv_array *array
argument_list|)
block|{ 	struct
name|strbuf
name|str
...
name|filename
init|=
name|git_path_bisect_expected_rev
argument_list|()
decl_stmt|;
name|struct
name|stat
...
end_function
begin_comment
comment|/*  * The terms used for this bisect session are stored in BISECT_TERMS.  * We read them and store them to adapt the messages accordingly.  * Default is bad/good.  */
end_comment
begin_function
