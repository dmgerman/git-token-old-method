...
condition|)
block|{
comment|/* 		 * FIXME: Why remove file from cache, and then 		 * immediately readd it?  Why not just overwrite using 		 * update_file only?  Also...this is buggy for 		 * rename/add-source situations... 		 */
name|remove_file_from_cache
argument_list|(
name|src
argument_list|)
...
name|path
decl_stmt|;
comment|/* same as ren2->pair->two->path */
