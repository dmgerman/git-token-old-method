...
specifier|inline
name|void
name|setup_rename_df_conflict_info
parameter_list|(
name|enum
name|rename_type
name|rename_type
...
literal|3
argument_list|,
literal|"Removing %s to make room for subdirectory; may re-add later."
argument_list|,
name|last_file
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|/* Handle D->F conflicts after all subfiles */
name|entry
operator|->
name|processed
operator|=
