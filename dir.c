...
literal|0
return|;
comment|/* 	 * The first 'prefix' characters of 'path' are common leading 	 * path components among the pathspecs we have seen so far, 	 * including the trailing slash. 	 */
name|prefix
operator|=
name|slash
operator|-
...
name|paths
argument_list|(
argument|a trailing slash is ok
argument_list|)
operator|,
end_expr_stmt
begin_if
if|if subdir is  * outside dir
DECL|variable|dir
operator|,
return|return
operator|-
