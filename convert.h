...
end_function_decl
begin_comment
comment|/*  * Use as much input up to *isize_p and fill output up to *osize_p;  * update isize_p and osize_p to indicate how much buffer space was  * consumed and filled. Return 0 on success, non-zero on error.  */
end_comment
begin_function_decl
specifier|extern
name|int
