...
parameter_list|)
block|{
comment|/* 	 * we are about to extract "path"; we would not want to lose 	 * anything in the existing directory there. 	 */
name|int
name|namelen
decl_stmt|;
name|int
...
argument_list|)
condition|)
comment|/* 			 * path is explicitly excluded, so it is Ok to 			 * overwrite it. 			 */
return|return;
if|if
condition|(
name|S_ISDIR
