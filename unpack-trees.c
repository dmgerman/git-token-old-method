...
name|data
decl_stmt|;
comment|/* merging two or more trees with an identical subdirectory? */
if|if
condition|(
operator|(
name|n
...
literal|0
return|;
comment|/* 	 * Instead of descending into the directory, keep the contents 	 * of the current index. 	 */
while|while
condition|(
literal|1
condition|)
...
condition|)
break|break;
comment|/* Is the entry still in that directory? */
if|if
condition|(
name|do_compare_entry
argument_list|(
...
literal|'/'
expr_stmt|;
comment|/* included, no clearing for any entries under this directory */
if|if
condition|(
operator|!
name|ret
...
return|;
block|}
comment|/* excluded, clear all selected entries under this directory. */
if|if
condition|(
name|ret
operator|==
