...
end_define
begin_comment
comment|/*  * Flags  * -----  *  * The following flags can be passed to `hold_lock_file_for_update()`.  */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*  * Append an appropriate error message to `buf` following the failure  * of `hold_lock_file_for_update()` to lock `path`. `err` should be the  * `errno` set by the failing call.  */
end_comment
begin_function_decl
specifier|extern
name|void
...
end_function_decl
begin_comment
comment|/*  * Emit an appropriate error message and `die()` following the failure  * of `hold_lock_file_for_update()` to lock `path`. `err` should be the  * `errno` set by the failing  * call.  */
end_comment
begin_function_decl
specifier|extern
name|NORETURN
