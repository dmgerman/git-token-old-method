...
name|to
expr_stmt|;
comment|/* yes this is a layering violation */
name|pack_file
operator|->
name|total
operator|=
...
name|pack_size
expr_stmt|;
comment|/* preserve the pack_file SHA1 ctx in case we have to truncate later */
name|sha1flush
argument_list|(
name|pack_file
argument_list|)
