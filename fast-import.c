...
index|[]
init|=
literal|"git-fast-import [--depth=n] [--active-branches=n] [--export-marks=marks.file] [--branch-log=log]"
decl_stmt|;
end_decl_stmt
begin_function
DECL|function|main
