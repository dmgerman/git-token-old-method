...
end_function
begin_function
DECL|function|invalidate_pack_id
specifier|static
name|void
name|invalidate_pack_id
parameter_list|(
name|unsigned
name|int
name|id
...
end_function
begin_function
DECL|function|loosen_small_pack
specifier|static
name|int
name|loosen_small_pack
parameter_list|(
specifier|const
name|struct
name|packed_git
...
end_function
begin_comment
comment|/*  * Given a pointer into a string, parse a mark reference:  *  *   idnum ::= ':' bigint;  *  * Return the first character after the value in *endptr.  *  * Complain if the following character is not what is expected,  * either a space or end of the string.  */
end_comment
begin_function
...
name|die
argument_list|(
literal|"No value after ':' in mark: %s"
argument_list|,
name|command_buf
operator|.
name|buf
...
end_function
begin_comment
comment|/*  * Parse the mark reference, and complain if this is not the end of  * the string.  */
end_comment
begin_function
DECL|function|parse_mark_ref_eol
specifier|static
name|uintmax_t
name|parse_mark_ref_eol
parameter_list|(
specifier|const
name|char
modifier|*
...
end_function
begin_comment
comment|/*  * Parse the mark reference, demanding a trailing space.  Return a  * pointer to the space.  */
end_comment
begin_function
DECL|function|parse_mark_ref_space
specifier|static
name|uintmax_t
name|parse_mark_ref_space
parameter_list|(
specifier|const
name|char
modifier|*
...
name|die
argument_list|(
literal|"Missing space after mark: %s"
argument_list|,
name|command_buf
operator|.
name|buf
...
name|git_config_get_int
argument_list|(
literal|"fastimport.unpacklimit"
argument_list|,
operator|&
name|limit
argument_list|)
