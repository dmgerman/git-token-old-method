...
name|die
argument_list|(
literal|"Failed to map generated pack: %s"
argument_list|,
name|strerror
argument_list|(
name|errno
...
name|die
argument_list|(
literal|"Error %i from zlib during inflate."
argument_list|,
name|st
argument_list|)
expr_stmt|;
...
name|die
argument_list|(
literal|"Error after inflate: sizes mismatch"
argument_list|)
expr_stmt|;
return|return
name|result
...
name|die
argument_list|(
literal|"I'm broken; I can't find a base I know must be here."
argument_list|)
expr_stmt|;
name|base
operator|=
...
name|die
argument_list|(
literal|"I created an object I can't read!"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|die
argument_list|(
literal|"Can't reinitailize branch %s"
argument_list|,
name|b
operator|->
name|name
...
name|die
argument_list|(
literal|"Garbage after string in: %s"
argument_list|,
name|command_buf
operator|.
name|buf
...
name|die
argument_list|(
literal|"Garbage after ref in: %s"
argument_list|,
name|command_buf
operator|.
name|buf
...
name|die
argument_list|(
literal|"Garbage after tag name in: %s"
argument_list|,
name|command_buf
operator|.
name|buf
...
index|[]
init|=
literal|"git-fast-import [--objects=n] [--depth=n] [--active-branches=n] [--export-marks=marks.file] [--branch-log=log] temp.pack"
decl_stmt|;
end_decl_stmt
begin_function
DECL|function|main
