...
argument_list|)
expr_stmt|;
comment|/* round out how much we map to 16 MB units */
name|pack_mlen
operator|=
name|pack_size
expr_stmt|;
...
name|die
argument_list|(
literal|"Error from zlib during inflate."
argument_list|)
expr_stmt|;
block|}
name|inflateEnd
...
name|sp
decl_stmt|;
comment|/* Obtain the new branch name from the rest of our command */
name|sp
operator|=
name|strchr
argument_list|(
...
name|die
argument_list|(
literal|"An lf did not terminate the branch command as expected."
argument_list|)
expr_stmt|;
block|}
end_function
...
index|[]
init|=
literal|"git-fast-import [--objects=n] [--depth=n] [--active-branches=n] temp.pack"
decl_stmt|;
end_decl_stmt
begin_function
DECL|function|main
