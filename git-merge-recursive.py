...
newline|'\n'
nl|'\n'
comment|'# NEEDSWORK: place dstNameA at stage 2 and dstNameB at stage 3'
nl|'\n'
comment|'# What about other stages???'
nl|'\n'
dedent|''
name|'updateFile'
op|'('
