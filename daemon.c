...
index|[]
init|=
literal|"git-daemon [--verbose] [--syslog] [--inetd | --port=n] [--export-all] [directory...]"
decl_stmt|;
end_decl_stmt
begin_comment
...
condition|)
break|break;
comment|/* End of string and all is good */
block|}
else|else
block|{
name|sl
...
argument_list|)
decl_stmt|;
comment|/* read_packet_line can return embedded \0 */
for|for
control|(
name|pp
operator|=
...
name|logerror
argument_list|(
literal|"Not a valid git-daemon-enabled repository: '%s'"
argument_list|,
name|dir
argument_list|)
expr_stmt|;
