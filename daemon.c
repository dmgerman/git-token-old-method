...
argument_list|)
decl_stmt|;
comment|/* The validation is done on the paths after enter_repo 		 * canonicalization, so whitelist should be written in 		 * terms of real pathnames (i.e. after ~user is expanded 		 * and symlinks resolved). 		 */
for|for
control|(
name|pp
operator|=
