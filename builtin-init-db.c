...
end_function
begin_comment
comment|/*  * Get the full path to the working tree specified in $GIT_WORK_TREE  * or NULL if no working tree is specified.  */
end_comment
begin_function
...
name|die
argument_list|(
literal|"Cannot change directory to specified working tree '%s'"
argument_list|,
name|git_work_tree
argument_list|)
expr_stmt|;
