...
name|try_to_simplify_commit
expr_stmt|;
comment|/* 		 * If we fix up parent data, we currently cannot 		 * do that on-the-fly. 		 */
if|if
condition|(
name|revs
operator|->
...
name|next
expr_stmt|;
comment|/* 		 * If we haven't done the list limiting, we need to look at 		 * the parents here 		 */
if|if
condition|(
operator|!
name|revs
