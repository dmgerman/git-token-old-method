...
specifier|static
name|void
name|mark_tree_contents_uninteresting
parameter_list|(
name|struct
name|tree
modifier|*
...
specifier|static
name|void
name|add_pending_object_with_path
parameter_list|(
name|struct
name|rev_info
modifier|*
...
name|die
argument_list|(
literal|"unable to add index blob to traversal"
argument_list|)
expr_stmt|;
name|add_pending_object_with_path
argument_list|(
...
name|symmetric
condition|?
literal|"Invalid symmetric difference expression %s"
else|:
literal|"Invalid revision range %s"
argument_list|,
name|arg
argument_list|)
expr_stmt|;
...
block|{
comment|/* A...B -- find merge bases between the two */
name|struct
name|commit
modifier|*
name|a
...
name|die
argument_list|(
literal|"--show-linear-break and --graph are incompatible"
argument_list|)
expr_stmt|;
return|return
literal|1
...
end_function
begin_function
DECL|function|diagnose_missing_default
specifier|static
name|void
name|NORETURN
name|diagnose_missing_default
parameter_list|(
specifier|const
name|char
modifier|*
...
name|_
argument_list|(
literal|"your current branch appears to be broken"
argument_list|)
argument_list|)
expr_stmt|;
name|skip_prefix
...
name|_
argument_list|(
literal|"your current branch '%s' does not have any commits yet"
argument_list|)
argument_list|,
name|refname
argument_list|)
...
define|#
directive|define
name|EMPTY_PARENT_LIST
value|((struct commit_list *)-1)
end_define
begin_comment
comment|/*  * You may only call save_parents() once per commit (this is checked  * for non-root commits).  */
end_comment
begin_function
...
condition|)
block|{
comment|/* 		 * --full-diff on simplified parents is no good: it 		 * will show spurious changes from the commits that 		 * were elided.  So we save the parents on the side 		 * when --full-diff is in effect. 		 */
if|if
condition|(
name|revs
operator|->
