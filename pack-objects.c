...
argument_list|)
expr_stmt|;
comment|/* 	 * Shift the size up by 7 bits at a time, 	 * until you get bits in the "high four". 	 * That will be our beginning. We'll have 	 * four size bits in 28..31, then groups 	 * of seven in 21..27, 14..20, 7..13 and 	 * finally 0..6. 	 */
if|if
condition|(
name|size
condition|)
