...
newline|'\n'
indent|'    '
string|'"""Run command with arguments.  Wait for command to complete.  If\n    the exit code was zero then return, otherwise raise\n    CalledProcessError.  The CalledProcessError object will have the\n    return code in the returncode attribute.\n\n    The arguments are the same as for the Popen constructor.  Example:\n\n    check_call(["ls", "-l"])\n    """'
newline|'\n'
name|'retcode'
op|'='
name|'call'
...
name|'ValueError'
op|'('
string|"'stdout argument not allowed, it will be overridden.'"
op|')'
newline|'\n'
dedent|''
name|'process'
