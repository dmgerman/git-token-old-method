...
parameter_list|)
block|{
comment|/* 	 * a line matching /^From $/ here would only have len == 4 	 * at this point because is_empty_line would've trimmed all 	 * trailing space 	 */
return|return
name|len
operator|>
literal|4
