...
end_function
begin_decl_stmt
DECL|variable|tracking_advice
specifier|static
specifier|const
name|char
name|tracking_advice
index|[]
init|=
name|N_
argument_list|(
literal|"\n"
literal|"After fixing the error cause you may try to fix up\n"
literal|"the remote tracking information by invoking\n"
...
name|_
argument_list|(
literal|"Unable to write upstream branch configuration"
argument_list|)
argument_list|)
expr_stmt|;
name|advise
...
end_function
begin_function
DECL|function|replace_each_worktree_head_symref
name|int
...
name|_
argument_list|(
literal|"HEAD of working tree %s is not updated"
argument_list|)
argument_list|,
name|worktrees
index|[
