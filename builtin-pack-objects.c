...
index|[]
init|=
literal|"\ git-pack-objects [{ -q | --progress | --all-progress }] [--max-pack-size=N] \n\ 	[--local] [--incremental] [--window=N] [--depth=N] \n\ 	[--no-reuse-delta] [--no-reuse-object] [--delta-base-offset] \n\ 	[--non-empty] [--revs [--unpacked | --all]*] [--reflog] \n\ 	[--stdout | base-name] [<ref-list |<object-list]"
decl_stmt|;
end_decl_stmt
begin_struct
...
block|{
comment|/* 				 * recover real object type in case 				 * check_object() wanted to re-use a delta, 				 * but we couldn't since base was in previous split pack 				 */
name|obj_type
operator|=
name|type
expr_stmt|;
...
end_function
begin_comment
comment|/* forward declarations for write_pack_file */
end_comment
begin_function_decl
specifier|static
name|void
