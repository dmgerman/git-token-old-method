...
parameter_list|)
block|{
comment|/* we already know this is a loose object with new type header. */
name|enum
name|object_type
name|type
decl_stmt|;
...
comment|/* differing core& pack compression when loose object -> must recompress */
if|if
condition|(
operator|!
name|entry
