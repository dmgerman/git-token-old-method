...
name|die_errno
argument_list|(
literal|"cannot create tempfile: %s"
argument_list|,
name|tmpfile
argument_list|)
expr_stmt|;
...
name|die_errno
argument_list|(
literal|"cannot close tempfile: %s"
argument_list|,
name|tmpfile
argument_list|)
expr_stmt|;
...
name|die_errno
argument_list|(
literal|"index-stream: git fast-import failed"
argument_list|)
expr_stmt|;
name|len
operator|=
...
name|len
argument_list|,
literal|"index-stream: feeding fast-import"
argument_list|)
expr_stmt|;
while|while
condition|(
...
name|die_errno
argument_list|(
literal|"index-stream: reading input"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die_errno
argument_list|(
literal|"index-stream: closing fast-import"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die_errno
argument_list|(
literal|"index-stream: finishing fast-import"
argument_list|)
expr_stmt|;
name|tmpfd
operator|=
...
name|die_errno
argument_list|(
literal|"index-stream: cannot open fast-import mark"
argument_list|)
expr_stmt|;
name|len
operator|=
...
name|die_errno
argument_list|(
literal|"index-stream: reading fast-import mark"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die_errno
argument_list|(
literal|"index-stream: closing fast-import mark"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die_errno
argument_list|(
literal|"index-stream: unlinking fast-import mark"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die_errno
argument_list|(
literal|"index-stream: unexpected fast-import mark:<%s>"
argument_list|,
name|buf
argument_list|)
expr_stmt|;
