...
literal|16
expr_stmt|;
comment|/* 	 * Now make sure none of the hash buckets has more entries than 	 * we're willing to test.  Otherwise we cull the entry list to 	 * limit identical three byte prefixes to still preserve a good 	 * repartition across the reference buffer. 	 */
for|for
control|(
name|i
operator|=
