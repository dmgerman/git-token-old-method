...
end_function
begin_comment
comment|/*  * Helper: In-place pass of sorting and merging the ranges in the  * range set, to re-establish the invariants after another operation  *  * NEEDSWORK currently not needed  */
end_comment
begin_function
...
name|die
argument_list|(
literal|"file %s has only %ld lines"
argument_list|,
name|name_part
argument_list|,
name|lines
